    ...
    methods:{
      ...
      save(){
        axios.post('/phonebook',this.$data.list).then((response)=> {
          this.close()
          //when we insert that time we have to update the parent component also
          // For this reason, we have to push the data bcz Add is our parent component
          // As a result we can see the data from db also in our homepage
          ...
          // then list er sob data remove kore dibo that means empty the model
          this.list = ""
        })
